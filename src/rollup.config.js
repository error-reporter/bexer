...
const LERNA_ROOT_PATH = '../../';
const PACKAGE_ROOT_PATH = process.cwd();
const GENERATED_PATH = Path.join(LERNA_ROOT_PATH, 'generated-for-type-checks');
const TARGET_PATH = Path.join(GENERATED_PATH, Path.basename(PACKAGE_ROOT_PATH));
...
const allInOnePath = Path.join(GENERATED_PATH, 'bexer-components');
