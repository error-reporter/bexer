...
this.BexerComponents.errorNotifier = (function (exports, utils, ErrorTypes) {
  ...
  */
  const loadIconAsBlobUrlAsync = (iconUrl = utils.mandatory()) => {
  ...
  */
  ...
  const installErrorNotifier = ({
    ...
    const notyClickedListener = utils.timeouted(
      /** @param {string} notyId */
      (notyId) => {
    ...
    const notyClosedListener = utils.timeouted(
      /** @param {string} notyId */
    ...
    */
    const notifyWithHandler = ({
      notyOptions = utils.mandatory(),
      clickHandler = utils.mandatory(),
    ...
    */
    const notifyAboutError = async ({
      ...
      errorEventLike = utils.mandatory(),
...
}({}, BexerComponents.utils, BexerComponents.errorTypes));
