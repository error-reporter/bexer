...
describe('Bexer.ErrorCatchers', () => {

  it('exports global Bexer variables', () => {
  ...
  it('exports api', () => {
    ...
    assert.isDefined(
      Bexer.ErrorCatchers.installListenersOn,
      'ErrorCatchers.installListenersOn is defined',
    );

  });

  describe('Bexer.ErrorCatchers.installListenersOn', () => {

    const install = Bexer.ErrorCatchers.installListenersOn;
    const newFakeWindow = () => ({
